...
window.onload=function(){
   <div class="bullets">|Private access in the safety of a separate account.|
        Hand selected, fully regulated managers with audited track records|
        Custody and trading at A credit rated institutions.|
        </div>
}//]]>  
...
<script>
  ...
  ga('create', 'UA-47445345-1', 'prosvest.com');
  ga('send', 'pageview');
